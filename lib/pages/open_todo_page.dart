...
final _itemController = TextEditingController();
    ...
    void _addItem(String item) {
      setState(() {
        itemList.add(Item(id: DateTime.now().millisecondsSinceEpoch, todoText: item));
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Título To-do List'),centerTitle: true,),
      body: Stack(
        children: [
          Padding(
              ...
              children: [
                ...
                children: [
                  for(Item item in itemList)
                    ToDoItem(item: item, onItemChecked: _handleCheckedItem, onDeleteItem: _deleteItem)
                  ],
                ),
              ],
            ),
